        ...
        <div style={{ animation: 'slideInFromLeft 1s ease-out' }} className="max-w-md w-full  rounded-xl shadow-2xl overflow-hidden p-8 space-y-8 mt-20 m-auto mb-28">
            ...
            <form method="POST" onSubmit={handleSubmit()} action="#" className="space-y-6">
                <div className="relative">
                    <input placeholder="john Doe" className="peer h-10 w-full border-b-2 border-black  bg-transparent placeholder-transparent focus:outline-none focus:border-purple-500" required id="name" name="name" type="text" onChange={(e) => setName(e.target.value)} value={name} />
                    <label className="absolute left-0 -top-3.5 text-black text-sm transition-all peer-placeholder-shown:text-base peer-placeholder-shown:text-black peer-placeholder-shown:top-2 peer-focus:-top-3.5 peer-focus:text-purple-500 peer-focus:text-sm" htmlFor="email">Full Name</label>
                </div>
                <div className="relative">
            ...
            <div className="text-center text-black">
                ...
                <Link className="text-purple-300 hover:underline" to="/login">Login</Link>
            </div>
        </div>
    );
}
