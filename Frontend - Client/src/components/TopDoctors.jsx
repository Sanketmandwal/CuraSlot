...
function TopDoctors() {
    ...
    return (
        <div className='flex flex-col items-center gap-4 my-16 text-gray-900 md:mx-10' >
            ...
            <button onClick={() => { navigate('/doctors'); scrollTo(0, 0) }} className='bg-blue-50 text-gray-600 px-12 py-3 rounded-full mt-10 hover:-translate-y-3 transition-all duration-100'>More</button>
        </div>
    )
}
